...
public class Assignment5actiTime {
public static void main(String[] args) 
 {  
	...
	cdriver.findElement(By.cssSelector(".projectSelector.searchItemList>div")).click();
	//Select costumer
	cdriver.findElement(By.cssSelector("div[class='itemRow cpItemRow ']:nth-child(4)")).click();
